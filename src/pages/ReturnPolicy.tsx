...
const ReturnPolicy = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: notConfigured ? 'Return policy created successfully' : 'Return policy updated successfully',
      });
    } catch (error) {
      toast({
        title: 'Error',
    ...
    <div className="space-y-6">
      ...
      {notConfigured && (
        <Alert>
          ...
          <AlertDescription>
            No return policy has been created yet. Enter your policy content below and click "Create Policy" to set it up.
          </AlertDescription>
        </Alert>
      )}
